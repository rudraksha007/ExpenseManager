...
export function QuarterlyReport({ data }: QuarterlyReportProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Quarterly Project Report</CardTitle>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
          ...
          <TableBody>
            {Object.entries(data.quarterlyAllocations).map(([category, values]: [string, any]) => (
