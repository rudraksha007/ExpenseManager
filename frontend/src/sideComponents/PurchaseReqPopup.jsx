...
function PurchaseReqPopup({ reset, id }) {
    ...
    useEffect(() => {
        async function fetchRequestDetails() {
            ...
            else setRequestDetails({requestNo: 'N/A',title: 'N/A',indentApproveDate: 'N/A',amount: 'N/A',status: 'N/A',category: 'N/A',person: 'N/A',
            ...
            <div className="projectPopupCont">
                ...
                <div className='requestDetailGroup'>
                    ...
                    <div className='requestDetailField'>
                        ...
                        <span>{requestDetails?.indentApproveDate}</span>
                    </div>
                    <div className='requestDetailField'>
                        <h4>Title</h4>
                    ...
                    <div className='requestDetailField'>
                        ...
                        <span>{requestDetails?.person}</span>
                    </div>
                    <div className='requestDetailField'>
                        <h4>Request Type</h4>
                ...
                <div className="requestPopupActions">
                    <FaEdit size={30} style={{ marginRight: 5 }} className='hoverable' title='Edit This Request' onClick={() => navigate(`/edit/:${id}`)} />
                    <FaCheck size={30} style={{ marginRight: 5 }} className='hoverable' title='Approve This Request' onClick={() => approve()} />
                </div>
            </div>
        </div>
    );
